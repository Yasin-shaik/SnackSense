...
const Details = () => {
  ...
  const { user, saveUserDetails } = useContext(AppContext); // Get saveUserDetails and user from context
  ...
  const handleDetails = async () => {
    ...
    const email = user.email;  // Use the user from context
    if (!email) return console.log("Email not available in context");

    // Call saveUserDetails from context and pass the user data
    saveUserDetails(userData);  // Save user details via context
